...
library(reshape2)
#Plot 2030/10
fleet = read.csv('2030_10_mean.csv')
...
#Plot 2030/50
fleet = read.csv('2030_50_mean.csv')
fleet2 = fleet[,c(2,7:16)]
fleet2 = fleet2[,c(1,10,5,2,7,6,4,9,3,8,11)]
colnames(fleet2) <- c("Years", "Coal", "Oil", "NGCC", "NGCT", "NGST", "Fission", "Hydropower", "Wind", "Solar", "Fusion")
fleet3 <- melt(fleet2, id.vars = 'Years', variable.name = 'Technology')
...
#Plot 2050/10
fleet = read.csv('2050_10_mean.csv')
fleet2 = fleet[,c(2,7:16)]
fleet2 = fleet2[,c(1,10,5,2,7,6,4,9,3,8,11)]
colnames(fleet2) <- c("Years", "Coal", "Oil", "NGCC", "NGCT", "NGST", "Fission", "Hydropower", "Wind", "Solar", "Fusion")
fleet3 <- melt(fleet2, id.vars = 'Years', variable.name = 'Technology')
p3 <- ggplot(fleet3, aes(x=Years, y=value/1000)) + 
  ...
  theme(legend.position="none")
#Plot 2050/50
fleet = read.csv('2050_50_mean.csv')
fleet2 = fleet[,c(2,7:16)]
fleet2 = fleet2[,c(1,10,5,2,7,6,4,9,3,8,11)]
colnames(fleet2) <- c("Years", "Coal", "Oil", "NGCC", "NGCT", "NGST", "Fission", "Hydropower", "Wind", "Solar", "Fusion")
fleet3 <- melt(fleet2, id.vars = 'Years', variable.name = 'Technology')
p4 <- ggplot(fleet3, aes(x=Years, y=value/1000)) + 
  ...
  theme(legend.position="none")
#Plot 2070/10
fleet = read.csv('2070_10_mean.csv')
fleet2 = fleet[,c(2,7:16)]
fleet2 = fleet2[,c(1,10,5,2,7,6,4,9,3,8,11)]
colnames(fleet2) <- c("Years", "Coal", "Oil", "NGCC", "NGCT", "NGST", "Fission", "Hydropower", "Wind", "Solar", "Fusion")
fleet3 <- melt(fleet2, id.vars = 'Years', variable.name = 'Technology')
p5 <- ggplot(fleet3, aes(x=Years, y=value/1000)) + 
  ...
  theme(legend.position="none")
#Plot 2070/50
fleet = read.csv('2070_50_mean.csv')
fleet2 = fleet[,c(2,7:16)]
fleet2 = fleet2[,c(1,10,5,2,7,6,4,9,3,8,11)]
colnames(fleet2) <- c("Years", "Coal", "Oil", "NGCC", "NGCT", "NGST", "Fission", "Hydropower", "Wind", "Solar", "Fusion")
fleet3 <- melt(fleet2, id.vars = 'Years', variable.name = 'Technology')
...
png(paste("mean_stacked2bw.png",sep=''), width=174, height=174, units='mm', res=300)
